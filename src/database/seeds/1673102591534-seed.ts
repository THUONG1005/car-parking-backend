...
export class seed1673102591534 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`INSERT INTO 
                            ...
                            VALUES 
                                ('Super admin', '2023-01-01', 'Khác', 'Hà Nội', '+840000000000', 'admin@gmail.com', '$2a$12$gYR65Z05BznHMEdiNZejqe1TY7DwKaXgE.Te7LYmvdFMSBa3/Q2G.', 'Admin'), 
                                ...
                                ('Trần Minh Thuyết', '2000-02-12', 'Nam', 'Hà Nội', '+840912861512', 'thuyettm2000@gmail.com', '$2a$12$gYR65Z05BznHMEdiNZejqe1TY7DwKaXgE.Te7LYmvdFMSBa3/Q2G.', 'User'), 
                                ...
                                ('Lê Quang Huy', '2000-07-23', 'Nam', 'Hà Nội', '+840337560589', 'huylq23072000@gmail.com', '$2a$12$gYR65Z05BznHMEdiNZejqe1TY7DwKaXgE.Te7LYmvdFMSBa3/Q2G.', 'User')`);
    await queryRunner.query(`INSERT INTO 
                                "price" ("value", "type") 
                            VALUES 
                                ('30000', 'Guest'), 
    ...
    await queryRunner.query(`INSERT INTO 
                            ...
                            VALUES 
                                ('338E93A7', 'Guest', 0, null), 
                                ('03AFF8AD', 'Guest', 0, null), 
                                ('032F7694', 'Guest', 0, null), 
                                ('83288DA7', 'Guest', 0, null), 
